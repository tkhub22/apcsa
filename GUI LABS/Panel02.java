...
public class Panel02 extends JPanel
{
   ...
   public Panel02()
   {
      ...
      rightButton = new JButton("Spongebob is very funny!");
      ...
      leftButton = new JButton("His name is Spongebob");
      ...
      topButton = new JButton("Meet Spongebob.");
      ...
      bottomButton = new JButton("We love Spongebob!");
      ...
      picture = new ImageIcon("spongebob.jpg");
